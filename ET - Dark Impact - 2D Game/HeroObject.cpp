...
//TABLICA WÊ¯A
void HeroObject::LoadMap(int arr[29][41])
{
...
void HeroObject::DrawMap(int arr[29][41])
{
	int type = 0;
	for (int row = 0; row < 29; row++)
	{
...
void HeroObject::InitializeTextures()
{
...
//ZARZ¥DZANIE WÊ¯EM
void HeroObject::InitializeHero()
{
	// Wymiarowanie Wê¿a
...
//USTAW PRÊDKOŒÆ WÊ¯A
void HeroObject::SetHeroSpeed()
{
	SDL_Delay(delay);
}

//USTAW PRÊDKOŒÆ WÊ¯A
void HeroObject::IsGameOver()
{

}

void HeroObject::HandleHeroGraphics()
{
	//Rysowanie wê¿a
	for (int i = 0; i < rozmiar; i++)
	{
...
//Sadzenie Jab³ek
void HeroObject::AppleTree(int arr[29][41])
{
