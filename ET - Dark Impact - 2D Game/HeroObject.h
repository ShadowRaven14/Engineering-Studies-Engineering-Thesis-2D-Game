...
public:
	...
	// ZARZ¥DZANIE WÊ¯EM
	void CreateHero();		// Utwórz Wê¿a	
	void InitializeTextures(); //Inicjalizuj grafiki
	void InitializeHero();	// Inicjalizuj Wê¿a
	void MoveWithHero();	// Zarz¹dzaj Wê¿em
	void SetHeroSpeed();	// Ustaw prêdkoœæ Wê¿a
	void IsGameOver();		// SprawdŸ warunki koñca
	void HandleHeroGraphics(); // Zarz¹dzaj grafikami Wê¿a
	void HandleKeyboard();	// Obs³uguj input klawiatury
	void FeedingHero();	// Nakarm Wê¿a
	// ZARZ¥DZANIE WÊ¯EM
